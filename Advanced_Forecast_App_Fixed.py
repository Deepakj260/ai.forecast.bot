...
# --- Load Historical Data Automatically (No Upload Required) ---
@st.cache_data
def load_data():
    return pd.read_excel("AI Bot Training Example.xlsx")  # File bundled with app
...
tariff_factor = 1.02   # 2% tariff impact
